...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c20 = "B";
  const peg$c21 = peg$literalExpectation("B", false);
  const peg$c22 = function(d: any): any {return parseInt(d.join(''),2)};
  const peg$c23 = "H";
  const peg$c24 = peg$literalExpectation("H", false);
  const peg$c25 = function(d: any): any {return parseInt(d.join(''),16)};
  const peg$c26 = function(d: any): any {return parseInt(d.join(''),10)};
  const peg$c27 = /^[0-9]/;
  const peg$c28 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c29 = /^[0-1]/;
  const peg$c30 = peg$classExpectation([["0", "1"]], false, false);
  const peg$c31 = /^[a-fA-F0-9]/;
  const peg$c32 = peg$classExpectation([["a", "f"], ["A", "F"], ["0", "9"]], false, false);
  const peg$c33 = /^[ \t]/;
